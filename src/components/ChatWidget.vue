      ...
      <div class="column">
        <div id="chat" top class="col scroll q-px-md text-vgrey" style="min-height: 30vh; max-height: 30vh">
          <div v-for="message in messages" :key="message.id" top>
            ...
            v-bind:name="message.author"
            v-if="message.author != nodeId" bg-color="vdark" text-color="white"
            v-bind:text="message.body" />
            <q-chat-message
            v-bind:id="message.id"
            name="me"
            v-if="message.author == nodeId" bg-color="vgrey" sent
            v-bind:text="message.body" />
          </div>
        </div>
