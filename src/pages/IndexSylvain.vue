       ...
       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<i>If you don't have a vDexNode:</i>
        ...
        <div class="q-py-sm">
          <div class="row q-py-sm justify-between">
            <div class="col-5">
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<q-btn color="blue-grey-14" label="Get the vDex node and check out the terms" @click=getInstaller />
            </div>
            <div  align="center">
        ...
        <br>
        <br>
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<i>List of nodes on the network:</i><br><br>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*You are required to vote for 21 nodes per day to activate the distribution of VTX.
